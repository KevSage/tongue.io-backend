...
class PhrasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post phrases_url, params: { phrase: { category: @phrase.category, input: @phrase.input } }, as: :json
    end
  ...
  test "should update phrase" do
    patch phrase_url(@phrase), params: { phrase: { category: @phrase.category, input: @phrase.input } }, as: :json
    assert_response 200
  end
