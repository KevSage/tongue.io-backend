...
languages = Language.create(
    [
    {abbr:"auto", name: "Auto Detect"},
    {abbr:"af", name: "Afrikaans"},
    {abbr:"sq", name: "Albanian"},
    {abbr:"am", name: "Amharaic"},
    {abbr:"ar", name: "Arabic"},
...
language_check = Language.find_by(name:language)
if language_check
    Nation.create(name:name, capital:capital, region:region, population:population, currency:currency, currency_code: currency_code, currency_symbol:currency_symbol, language_id:language_check.id, flag:flag)
end
...
#     t.string "language"
#     t.string "flag"
#     t.datetime "created_at", precision: 6, "": false
#     t.datetime "updated_at", precision: 6, "": false
#   end